...
- Housing supply spillovers with submarkets
- Proposition 13 structural model
  - move to debt financing, changes in municipal tax revenue sources, services
  - response to budget crises: illiquid assets vs liquid services
  - impact on housing approvals, land use decisions (construct the tax gap between land uses)
  - distributional impacts
- Disasters
- Impacts of rent control 
  - redevelopment (selection vs more, Diamond and McQuade)
  - insurance value given liquidity constraints, value of stability
- Ag + …
...
#| echo: false
#| fig-width: 7
hist(atp$award_req, breaks=20, xlab="Funding Requested ($1000)", col="dodgerblue",
     main="All Projects")

hist(atp[award_req < 10000, award_req], breaks=20, xlab="Funding Requested ($1000)", 
     col="orange", main="Requesting Less Than $10 Million", ylab = "")
```
